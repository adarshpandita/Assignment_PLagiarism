    ...
    public partial class Form2 : Form
    {
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (url_to_scan != null)
                {
                    if (!File.Exists(url_to_scan))
                    {
                        listBox1.Items.Add("ERROR: The file '" + url_to_scan  + "' does not exist."); // Bad URL format.
                        Environment.Exit(1);
                    }

                    scanProcess = copyleaks.CreateByFile(new FileInfo(url_to_scan), scanOptions);
            ...
            catch (UnauthorizedAccessException)
            {
                ...
                listBox1.Items.Add("* You did not log in to cloud");
        ...
        {
          richTextBox2.Text = listBox1.SelectedItem.ToString();
        }
    }
}
